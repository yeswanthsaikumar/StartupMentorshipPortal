...
class User( UserMixin, db.Model):
	...
	about_venture = db.Column(db.String(150) )
	last_seen = db.Column(db.DateTime , default=datetime.utcnow)
	facebook = db.Column(db.String(80) , index=True  ) 
	linkedin = db.Column(db.String(80) , index=True )
	twitter = db.Column(db.String(80) , index=True)
	experience = db.Column(db.String(150) , default=None)
	mentor_expections = db.Column(db.String(50) )
	max_fund= db.Column(db.String(50))
	profession = db.Column(db.String(60))
	user_category = db.Column(db.String(50))
	phone_no = db.Column(db.String(15)  , index=True , default=None)
